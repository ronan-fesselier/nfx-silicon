...
/**
 * \file Xnor.h
 * \brief Declares the Xnor primitive.
 */
...
namespace nfx::silicon::primitive
{
     ...
     *   any   | HighZ | HighZ
     */
    class Xnor final : public component::IPassive
    {
    public:
        /**
         * \enum Terminal
         * \brief Identifies the terminals of the Xnor gate.
         */
        ...
        /**
         * \struct Descriptor
         * \brief Immutable configuration for Xnor construction.
         */
        struct Descriptor
        {
        ...
        /**
         * \brief Constructs an Xnor gate from a descriptor.
         * \param descriptor Gate configuration.
         */
        explicit Xnor(const Descriptor& descriptor);
