...
/**
 * \file And.h
 * \brief Declares the And primitive.
 */
...
namespace nfx::silicon::primitive
{
     ...
     *   any   | HighZ | HighZ
     */
    class And final : public component::IPassive
    {
    public:
        /**
         * \enum Terminal
         * \brief Identifies the terminals of the And gate.
         */
        ...
        /**
         * \struct Descriptor
         * \brief Immutable configuration for And construction.
         */
        struct Descriptor
        {
        ...
        /**
         * \brief Constructs an And gate from a descriptor.
         * \param descriptor Gate configuration.
         */
        explicit And(const Descriptor& descriptor);
