...
/**
 * \file Xor.h
 * \brief Declares the Xor primitive.
 */
...
namespace nfx::silicon::primitive
{
     ...
     *   any   | HighZ | HighZ
     */
    class Xor final : public component::IPassive
    {
    public:
        /**
         * \enum Terminal
         * \brief Identifies the terminals of the Xor gate.
         */
        ...
        /**
         * \struct Descriptor
         * \brief Immutable configuration for Xor construction.
         */
        struct Descriptor
        {
        ...
        /**
         * \brief Constructs an Xor gate from a descriptor.
         * \param descriptor Gate configuration.
         */
        explicit Xor(const Descriptor& descriptor);
