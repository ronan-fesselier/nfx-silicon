...
/**
 * \file Nor.h
 * \brief Declares the Nor primitive.
 */
...
namespace nfx::silicon::primitive
{
     ...
     *   any   | HighZ | HighZ
     */
    class Nor final : public component::IPassive
    {
    public:
        /**
         * \enum Terminal
         * \brief Identifies the terminals of the Nor gate.
         */
        ...
        /**
         * \struct Descriptor
         * \brief Immutable configuration for Nor construction.
         */
        struct Descriptor
        {
        ...
        /**
         * \brief Constructs a Nor gate from a descriptor.
         * \param descriptor Gate configuration.
         */
        explicit Nor(const Descriptor& descriptor);
