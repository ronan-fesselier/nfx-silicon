...
/**
 * \file Resistor.h
 * \brief Declares the Resistor passive component.
 */
...
namespace nfx::silicon::discrete
{
    /**
     * \class Resistor
     * \brief Two-terminal passive component with a fixed resistance.
     */
    class Resistor final : public component::IDipole
    {
    public:
        /**
         * \enum Terminal
         * \brief Identifies the two terminals of the resistor.
         */
        ...
        /**
         * \struct Descriptor
         * \brief Immutable configuration for Resistor construction.
         */
        struct Descriptor
        {
            const char* name; ///< Component name
            float ohms;       ///< Resistance value
        };

        /**
         * \brief Constructs a resistor from a descriptor.
         * \param descriptor Resistor configuration.
         */
        explicit Resistor(const Descriptor& descriptor);
