...
/**
 * \file LS08.h
 * \brief Declares the SN74LS08 quad 2-input AND gate package.
 */
...
namespace nfx::silicon::gate::sn74xxx
{
    /**
     * \class LS08
     * \brief SN74LS08 quad 2-input AND gate: four independent And gates in a DIP-14 package.
     *
     * Encapsulates four And gate primitives behind a DIP-14 pin interface.
     ...
     *   any   | HighZ | HighZ
     */
    class LS08 final : public component::IPassive
    {
    public:
        /**
         * \enum Terminal
         * \brief Identifies the DIP-14 terminals of the LS08.
         */
        ...
        /**
         * \struct Descriptor
         * \brief Immutable configuration for LS08 construction.
         */
        struct Descriptor
        {
        ...
        /**
         * \brief Constructs an LS08 from a descriptor.
         * \param descriptor Package configuration.
         */
        explicit LS08(const Descriptor& descriptor);
