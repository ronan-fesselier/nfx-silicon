...
/**
 * \file LS32.h
 * \brief Declares the SN74LS32 quad 2-input OR gate package.
 */

#include "nfx/silicon/component/IPassive.h"
#include "nfx/silicon/primitive/Or.h"
...
namespace nfx::silicon::gate::sn74xxx
{
    /**
     * \class LS32
     * \brief SN74LS32 quad 2-input OR gate: four independent Or gates in a DIP-14 package.
     *
     * Encapsulates four Or gate primitives behind a DIP-14 pin interface.
     ...
     *   any   | HighZ | HighZ
     */
    class LS32 final : public component::IPassive
    {
    public:
        /**
         * \enum Terminal
         * \brief Identifies the DIP-14 terminals of the LS32.
         */
        enum class Terminal : std::uint8_t
        {
            ...
            A3, ///< pin 10 Gate 3 input A
            B3, ///< pin 9  Gate 3 input B
            Y4, ///< pin 11 Gate 4 output
            A4, ///< pin 13 Gate 4 input A
            B4, ///< pin 12 Gate 4 input B
            VCC ///< pin 14 Power supply
        };

        /**
         * \struct Descriptor
         * \brief Immutable configuration for LS32 construction.
         */
        struct Descriptor
        {
        ...
        /**
         * \brief Constructs an LS32 from a descriptor.
         * \param descriptor Package configuration.
         */
        explicit LS32(const Descriptor& descriptor);
    ...
    private:
        ...
        std::array<primitive::Or, 4> m_gates;
