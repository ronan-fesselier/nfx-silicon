...
- `tests_cd4xxx`: unit tests for CD4011B, CD4049UB, CD4050B (construction, DIP-14 pin names, Terminal enum, full truth table all four gates, HighZ propagation, gate independence, VDD removal, VDD below range, component name)
