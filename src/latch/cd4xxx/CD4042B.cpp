#include "nfx/silicon/latch/cd4xxx/CD4042B.h"
...
namespace nfx::silicon::latch::cd4xxx
{
    ...
    CD4042B::CD4042B(const Descriptor& descriptor)
        : m_descriptor{ descriptor },
          m_latch1{ primitive::DLatch::Descriptor{ .name = "L1" } },
          m_latch2{ primitive::DLatch::Descriptor{ .name = "L2" } },
          m_latch3{ primitive::DLatch::Descriptor{ .name = "L3" } },
          m_latch4{ primitive::DLatch::Descriptor{ .name = "L4" } },
                     ...
                     &m_pinNQ2, &m_pinQ2, &m_pinQ3,  &m_pinNQ3, &m_pinD3,    &m_pinD4,       &m_pinNQ4, &m_pinVDD }
    {
        ...
        m_pinD1.connect<Level>([this](const Level l) {
            ...
            m_latch1.pin(primitive::DLatch::Terminal::D).drive<Level>(l);
        });
        m_pinD2.connect<Level>([this](const Level l) {
            ...
            m_latch2.pin(primitive::DLatch::Terminal::D).drive<Level>(l);
        });
        m_pinD3.connect<Level>([this](const Level l) {
            ...
            m_latch3.pin(primitive::DLatch::Terminal::D).drive<Level>(l);
        });
        m_pinD4.connect<Level>([this](const Level l) {
            ...
            m_latch4.pin(primitive::DLatch::Terminal::D).drive<Level>(l);
        });

        m_latch1.pin(primitive::DLatch::Terminal::Q).connect<Level>([this](const Level l) {
            if (!m_powered)
            {
                return;
            }
        ...
        m_latch1.pin(primitive::DLatch::Terminal::NQ).connect<Level>([this](const Level l) {
            if (!m_powered)
            {
                return;
            }
        ...
        m_latch2.pin(primitive::DLatch::Terminal::Q).connect<Level>([this](const Level l) {
            if (!m_powered)
            {
                return;
            }
        ...
        m_latch2.pin(primitive::DLatch::Terminal::NQ).connect<Level>([this](const Level l) {
            if (!m_powered)
            {
                return;
            }
        ...
        m_latch3.pin(primitive::DLatch::Terminal::Q).connect<Level>([this](const Level l) {
            if (!m_powered)
            {
                return;
            }
        ...
        m_latch3.pin(primitive::DLatch::Terminal::NQ).connect<Level>([this](const Level l) {
            if (!m_powered)
            {
                return;
            }
        ...
        m_latch4.pin(primitive::DLatch::Terminal::Q).connect<Level>([this](const Level l) {
            if (!m_powered)
            {
                return;
            }
        ...
        m_latch4.pin(primitive::DLatch::Terminal::NQ).connect<Level>([this](const Level l) {
            if (!m_powered)
            {
                return;
            }
    ...
    void CD4042B::onClockOrPolarity()
    {
        ...
        m_latch1.pin(primitive::DLatch::Terminal::EN).drive<Level>(cl);
        m_latch2.pin(primitive::DLatch::Terminal::EN).drive<Level>(cl);
        m_latch3.pin(primitive::DLatch::Terminal::EN).drive<Level>(cl);
        m_latch4.pin(primitive::DLatch::Terminal::EN).drive<Level>(cl);
    }
} // namespace nfx::silicon::latch::cd4xxx
