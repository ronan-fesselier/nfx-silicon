...
namespace nfx::silicon::gate::cd4xxx
{
                     ...
                     &m_pinSET2, &m_pinD2,  &m_pinRESET2, &m_pinCLOCK2, &m_pinNQ2, &m_pinQ2,   &m_pinVDD }
    {
        ...
        m_pinSET1.connect<Level>([this](const Level l) {
            ...
            m_ff1.pin(DFlipFlop::Terminal::PRE).drive<Level>(invert(l));
        });
        m_pinRESET1.connect<Level>([this](const Level l) {
            ...
            m_ff1.pin(DFlipFlop::Terminal::CLR).drive<Level>(invert(l));
        });
        ...
        m_pinSET2.connect<Level>([this](const Level l) {
            ...
            m_ff2.pin(DFlipFlop::Terminal::PRE).drive<Level>(invert(l));
        });
        m_pinRESET2.connect<Level>([this](const Level l) {
            ...
            m_ff2.pin(DFlipFlop::Terminal::CLR).drive<Level>(invert(l));
        });
