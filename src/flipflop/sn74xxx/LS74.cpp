#include "nfx/silicon/flipflop/sn74xxx/LS74.h"
...
namespace nfx::silicon::flipflop::sn74xxx
{
                     ...
                     &m_pin2NQ,  &m_pin2Q, &m_pin2PRE, &m_pin2CLK, &m_pin2D, &m_pin2CLR, &m_pinVCC }
    {
        m_pin1CLR.connect<Level>([this](const Level l) {
            ...
            m_ff1.pin(primitive::DFlipFlop::Terminal::CLR).drive<Level>(l);
        });
        ...
        m_pin1PRE.connect<Level>([this](const Level l) {
            ...
            m_ff1.pin(primitive::DFlipFlop::Terminal::PRE).drive<Level>(l);
        });
        ...
        m_pin2CLR.connect<Level>([this](const Level l) {
            ...
            m_ff2.pin(primitive::DFlipFlop::Terminal::CLR).drive<Level>(l);
        });
        ...
        m_pin2PRE.connect<Level>([this](const Level l) {
            ...
            m_ff2.pin(primitive::DFlipFlop::Terminal::PRE).drive<Level>(l);
        });
